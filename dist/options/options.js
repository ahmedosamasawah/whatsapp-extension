...
REPLY: A natural, helpful suggested reply to this message`,
	...
	var root = template(`<div class="container svelte-q9lhwm"><h1 class="svelte-q9lhwm">WhatsApp AI Transcriber Plus Settings</h1> <section class="settings-section svelte-q9lhwm"><h2 class="svelte-q9lhwm">API Key</h2> <form><div class="form-group svelte-q9lhwm"><label for="api-key" class="svelte-q9lhwm">OpenAI API Key</label> <div class="input-group svelte-q9lhwm"><input type="text" id="api-key" placeholder="sk-..." class="svelte-q9lhwm"> <button type="submit" class="svelte-q9lhwm"> </button></div> <!></div></form> <div class="info-box svelte-q9lhwm"><h3 class="svelte-q9lhwm">How to Get an OpenAI API Key</h3> <ol><li>Go to <a href="https://platform.openai.com/signup" target="_blank" class="svelte-q9lhwm">OpenAI Platform</a> and create an account or sign in.</li> <li>Navigate to <a href="https://platform.openai.com/api-keys" target="_blank" class="svelte-q9lhwm">API Keys</a> in your account dashboard.</li> <li>Click on "Create new secret key" and copy the key.</li> <li>Paste the key in the field above and click "Save & Verify".</li></ol> <p class="note svelte-q9lhwm">Note: The OpenAI API is a paid service. You will be charged based on
        your usage.</p></div></section> <section class="settings-section svelte-q9lhwm"><h2 class="svelte-q9lhwm">AI Models</h2> <form><div class="form-group svelte-q9lhwm"><label for="transcription-model" class="svelte-q9lhwm">Transcription Model</label> <select id="transcription-model" class="svelte-q9lhwm"></select></div> <div class="form-group svelte-q9lhwm"><label for="analysis-model" class="svelte-q9lhwm">Analysis Model</label> <select id="analysis-model" class="svelte-q9lhwm"></select> <p class="helper-text svelte-q9lhwm">This model processes the transcription to generate the cleaned
          version, summary, and suggested reply.</p></div> <div class="button-row svelte-q9lhwm"><button type="submit" class="svelte-q9lhwm">Save Model Settings</button></div></form></section> <section class="settings-section svelte-q9lhwm"><h2 class="svelte-q9lhwm">Transcription Settings</h2> <form><div class="form-group svelte-q9lhwm"><label for="language" class="svelte-q9lhwm">Preferred Language</label> <select id="language" class="svelte-q9lhwm"></select> <p class="helper-text svelte-q9lhwm">Auto-detect will try to identify the language in the audio.</p></div> <div class="checkbox-group svelte-q9lhwm"><h3 class="svelte-q9lhwm">Generate Outputs</h3> <label class="checkbox-label svelte-q9lhwm"><input type="checkbox" class="svelte-q9lhwm"> <span>Cleaned Version (fixed grammar, filler removal)</span></label> <label class="checkbox-label svelte-q9lhwm"><input type="checkbox" class="svelte-q9lhwm"> <span>Brief Summary</span></label> <label class="checkbox-label svelte-q9lhwm"><input type="checkbox" class="svelte-q9lhwm"> <span>Suggested Reply</span></label></div> <div class="form-group svelte-q9lhwm"><label for="prompt-template" class="svelte-q9lhwm">Prompt Template</label> <div class="textarea-with-buttons svelte-q9lhwm"><textarea id="prompt-template" rows="8" class="svelte-q9lhwm"></textarea> <button type="button" class="reset-button svelte-q9lhwm">Reset to Default</button></div> <p class="helper-text svelte-q9lhwm">This prompt is sent to the AI model to generate the outputs. Use
          "TRANSCRIPT" as a placeholder for the transcription.</p></div> <div class="button-row svelte-q9lhwm"><button type="submit" class="svelte-q9lhwm">Save Settings</button></div></form></section></div>`);
...
4. REPLY: A natural, helpful suggested reply to this message`;
...

		{
			var consequent = ($$anchor) => {
				...
				template_effect(
					($0) => {
						classes = set_class(div_3, 1, 'status-message svelte-q9lhwm', null, classes, $0);

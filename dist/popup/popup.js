...
4. REPLY: A natural, helpful suggested reply to this message`,
	...
	var root = template(`<div class="container svelte-1rt4zx8"><header class="svelte-1rt4zx8"><h1 class="svelte-1rt4zx8">WhatsApp AI Transcriber Plus</h1></header> <div class="status-container svelte-1rt4zx8"><div class="status-row svelte-1rt4zx8"><span class="status-label svelte-1rt4zx8">Status:</span> <span><span></span> </span></div> <div class="status-row svelte-1rt4zx8"><span class="status-label svelte-1rt4zx8">Extension:</span> <label class="toggle svelte-1rt4zx8"><input type="checkbox" class="svelte-1rt4zx8"> <span class="slider svelte-1rt4zx8"></span></label></div></div> <div class="button-container svelte-1rt4zx8"><button class="settings-button svelte-1rt4zx8">Open Settings</button></div> <div class="info svelte-1rt4zx8"><p class="svelte-1rt4zx8">This extension transcribes WhatsApp voice messages using AI and provides:</p> <ul class="svelte-1rt4zx8"><li class="svelte-1rt4zx8">Raw transcription</li> <li class="svelte-1rt4zx8">Cleaned version</li> <li class="svelte-1rt4zx8">Brief summary</li> <li class="svelte-1rt4zx8">Suggested reply</li></ul> <p class="svelte-1rt4zx8"><!></p></div></div>`);
	...
	function Popup($$anchor, $$props) {
		...
		template_effect(
			($0, $1) => {
				classes = set_class(span, 1, 'status-value svelte-1rt4zx8', null, classes, $0);
				classes_1 = set_class(span_1, 1, 'status-icon svelte-1rt4zx8', null, classes_1, $1);

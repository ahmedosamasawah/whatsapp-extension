...
4. REPLY: A natural, helpful suggested reply to this message`,
	...
	function TranscribeButton($$anchor, $$props) {
		...
		template_effect(
			($0) => {
				classes = set_class(button, 1, 'transcribe-button svelte-ype04t', null, classes, $0);
				set_text(text, get$1(buttonText));
			},
			[
				() => ({
					transcribed: get$1(isTranscribed),
					loading: get$1(isLoading)
				})
			],
			derived_safe_equal
		);
	...
	function handleUseReply(_, useReply, data, close) {
		useReply()(data().reply);
		close()();
	}
			...
			var consequent_7 = ($$anchor) => {
				...
				each(div_3, 5, () => tabs, index, ($$anchor, tab) => {
					...
					template_effect(
						...
						[
							() => ({
								active: get$1(activeTab) === get$1(tab).id
							})
						],
						derived_safe_equal
					);
					...
					var alternate = ($$anchor, $$elseif) => {
						{
							var consequent_1 = ($$anchor) => {
								...
								var p = child(div_6);
								var text_3 = child(p);
								template_effect(() => set_text(text_3, data().transcript));
								append($$anchor, div_6);
							};
							...
							var alternate_1 = ($$anchor, $$elseif) => {
								{
									var consequent_2 = ($$anchor) => {
										...
										template_effect(() => set_text(text_4, data().cleaned));
										append($$anchor, div_7);
									};
									...
									var alternate_2 = ($$anchor, $$elseif) => {
										{
											var consequent_3 = ($$anchor) => {
												...
												template_effect(() => set_text(text_5, data().summary));
												append($$anchor, div_8);
											};
											...
											var alternate_3 = ($$anchor, $$elseif) => {
												{
													var consequent_4 = ($$anchor) => {
														...
														template_effect(() => set_text(text_6, data().reply));
														append($$anchor, div_9);
													};
													...
													if_block(
														$$anchor,
														($$render) => {
															if (get$1(activeTab) === "reply") $$render(consequent_4);
														},
														$$elseif
													);
												}
											...
											if_block(
												$$anchor,
												($$render) => {
													if (get$1(activeTab) === "summary") $$render(consequent_3); else $$render(alternate_3, false);
												},
												$$elseif
											);
										}
									...
									if_block(
										$$anchor,
										($$render) => {
											if (get$1(activeTab) === "cleaned") $$render(consequent_2); else $$render(alternate_2, false);
										},
										$$elseif
									);
								}
							...
							if_block(
								$$anchor,
								($$render) => {
									if (get$1(activeTab) === "transcript") $$render(consequent_1); else $$render(alternate_1, false);
								},
								$$elseif
							);
						}
					...
					var consequent_6 = ($$anchor) => {
...

						{
							var consequent_5 = ($$anchor) => {
								...
								button_3.__click = [handleUseReply, useReply, data, close];
								append($$anchor, button_3);
							};

							if_block(node_3, ($$render) => {
								if (get$1(activeTab) === "reply" && data().reply) $$render(consequent_5);
							});
						}

						template_effect(() => button_2.disabled = !data()[get$1(activeTab)]);
